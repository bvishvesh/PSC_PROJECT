...
class VisualSolve:
    ...
    def add_distance_visual_element(self, master):
        label_distance = ttk.Label(master, text="Current distance:", background='green',
                                   font=('times', 12, 'bold'))
    ...
    def create_initial_population_visual_element(self):
        ...
        option1 = OptionMenu(self.frame, var, "shuffle")
        ...
        self.w = Scale(self.frame, from_=70, to=1000, resolution=10, orient=HORIZONTAL)
    ...
    def create_offsprings_round_one(self):
        ...
        self.crounds = Scale(self.frame, from_=1, to=1000, resolution=50, orient=HORIZONTAL)
    ...
    def start_solving(self):
        def callback():
            self.round_pop_size = self.initial_population_size - 50
