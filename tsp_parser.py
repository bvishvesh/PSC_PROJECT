    ...
    def __init__(self, filename):
        ...
        if self.check_filename(filename):
            ...
            if self.check_dimension(self.filename, self.dimension):
                ...
                self.display_status = ('Please make sure you have a valid TSP data file.\n'
                                       'Please use another file or correct the one you have')
        else:
            self.display_status = 'This is not a valid TSP file Please use another one!'
...
if __name__ == '__main__':
    newtsp = TSPParser("TSP_Problems/a280.tsp")#loading the initial file u can take any valid tsp file here instead of a280.tsp